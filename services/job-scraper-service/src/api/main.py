...
from src.db_client import save_job_to_db, APIError # Removed ConnectionError for now as it's not explicitly raised in db_client
...
async def receive_new_job(job: JobData):
    ...
    try:
        ...
        # Since save_job_to_db is now synchronous, we call it directly.
